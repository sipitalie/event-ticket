...
describe("Event Entity  create",()=>{
    ...
    const eventInput={event_date:"2022-10-14",number_of_areas:1,owner_id:"sipitale-22176",title:"Siga la luna"}
    const event =new Event(eventInput)
    expect(event).toBeInstanceOf(Event)           
    })

    test("connot to crate an Event with date is before three days from today's date",()=>{
        const eventInput={event_date:"2022-10-09",number_of_areas:1,owner_id:"sipitale-22176",title:"Siga la luna"}
        expect(()=>{
